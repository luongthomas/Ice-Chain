...
contract Deal {
  ...
  function queryOrder(uint number) constant public returns (address buyer, string goods, uint quantity, uint price, uint safepay, uint delivery_price, uint delivery_safepay) {
